...
if (!args.workspace || !args.renderer) { console.error('Usage: node scripts/render-courseware.mjs --workspace=/path --renderer=pilot-html|tongcheng-teach-html|codex-artifact|anthropic-pptxgenjs|compare [--run-id=id]'); process.exit(2); }
